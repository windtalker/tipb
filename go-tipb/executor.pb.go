...
type Join struct {
	JoinType             *int64    `protobuf:"varint,1,req,name=join_type,json=joinType" json:"join_type,omitempty"`
	JoinExecType         *int64    `protobuf:"varint,2,req,name=join_exec_type,json=joinExecType" json:"join_exec_type,omitempty"`
	BuildExec            *Executor `protobuf:"bytes,3,req,name=build_exec,json=buildExec" json:"build_exec,omitempty"`
	ProbeExec            *Executor `protobuf:"bytes,4,req,name=probe_exec,json=probeExec" json:"probe_exec,omitempty"`
	JoinCond             *Expr     `protobuf:"bytes,5,req,name=join_cond,json=joinCond" json:"join_cond,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *Join) GetJoinExecType() int64 {
...
func (m *Join) GetBuildExec() *Executor {
	if m != nil {
		return m.BuildExec
	}
	return nil
...
func (m *Join) GetProbeExec() *Executor {
	if m != nil {
		return m.ProbeExec
	}
	return nil
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
...
func (m *Join) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.JoinCond == nil {
		...
		{
			size, err := m.JoinCond.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ProbeExec == nil {
		...
		{
			size, err := m.ProbeExec.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.BuildExec == nil {
		...
		{
			size, err := m.BuildExec.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Join) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BuildExec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BuildExec == nil {
				m.BuildExec = &Executor{}
			}
			if err := m.BuildExec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProbeExec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProbeExec == nil {
				m.ProbeExec = &Executor{}
			}
			if err := m.ProbeExec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JoinCond", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.JoinCond.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
