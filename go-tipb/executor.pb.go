...
func (JoinType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{1} }
...
func (JoinExecType) EnumDescriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{2} }
...
type TableScan struct {
	...
	Engine           int64         `protobuf:"varint,4,opt,name=engine" json:"engine"`
	XXX_unrecognized []byte        `json:"-"`
}
...
func (m *TableScan) GetEngine() int64 {
	if m != nil {
		return m.Engine
	}
	return 0
...
func (m *TableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x20
	i++
	i = encodeVarintExecutor(dAtA, i, uint64(m.Engine))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *TableScan) Size() (n int) {
	...
	n += 2
	n += 1 + sovExecutor(uint64(m.Engine))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
var fileDescriptorExecutor = []byte{
	...
	,
}
