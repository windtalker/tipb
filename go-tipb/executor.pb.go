...
type TableScan struct {
	...
	NextReadEngine   *EngineType   `protobuf:"varint,4,opt,name=next_read_engine,json=nextReadEngine,enum=tipb.EngineType" json:"next_read_engine,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}
...
type Join struct {
	...
	LeftChildren     []*Executor  `protobuf:"bytes,3,rep,name=left_children,json=leftChildren" json:"left_children,omitempty"`
	RightChildren    []*Executor  `protobuf:"bytes,4,rep,name=right_children,json=rightChildren" json:"right_children,omitempty"`
	InnerIdx         int64        `protobuf:"varint,5,opt,name=inner_idx,json=innerIdx" json:"inner_idx"`
	LeftJoinKeys     []*Expr      `protobuf:"bytes,6,rep,name=left_join_keys,json=leftJoinKeys" json:"left_join_keys,omitempty"`
	RightJoinKeys    []*Expr      `protobuf:"bytes,7,rep,name=right_join_keys,json=rightJoinKeys" json:"right_join_keys,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (m *Join) GetLeftChildren() []*Executor {
	if m != nil {
		return m.LeftChildren
	}
	return nil
}

func (m *Join) GetRightChildren() []*Executor {
	if m != nil {
		return m.RightChildren
	}
	return nil
}
...
func (m *Join) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftChildren) > 0 {
		for _, msg := range m.LeftChildren {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.RightChildren) > 0 {
		for _, msg := range m.RightChildren {
			dAtA[i] = 0x22
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Join) Size() (n int) {
	...
	if len(m.LeftChildren) > 0 {
		for _, e := range m.LeftChildren {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.RightChildren) > 0 {
		for _, e := range m.RightChildren {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *Join) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeftChildren", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LeftChildren = append(m.LeftChildren, &Executor{})
			if err := m.LeftChildren[len(m.LeftChildren)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RightChildren", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RightChildren = append(m.RightChildren, &Executor{})
			if err := m.RightChildren[len(m.RightChildren)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
