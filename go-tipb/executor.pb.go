...
type Join struct {
	...
	LeftCondition    []*Expr      `protobuf:"bytes,9,rep,name=left_condition,json=leftCondition" json:"left_condition,omitempty"`
	RightCondition   []*Expr      `protobuf:"bytes,10,rep,name=right_condition,json=rightCondition" json:"right_condition,omitempty"`
	OtherCondition   []*Expr      `protobuf:"bytes,11,rep,name=other_condition,json=otherCondition" json:"other_condition,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (m *Join) GetLeftCondition() []*Expr {
	if m != nil {
...
func (m *Join) GetRightCondition() []*Expr {
	if m != nil {
...
func (m *Join) GetOtherCondition() []*Expr {
	if m != nil {
		return m.OtherCondition
	}
	return nil
}
...
func (m *Join) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftCondition) > 0 {
		for _, msg := range m.LeftCondition {
			dAtA[i] = 0x4a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.RightCondition) > 0 {
		for _, msg := range m.RightCondition {
			dAtA[i] = 0x52
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.OtherCondition) > 0 {
		for _, msg := range m.OtherCondition {
			dAtA[i] = 0x5a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Join) Size() (n int) {
	...
	if len(m.LeftCondition) > 0 {
		for _, e := range m.LeftCondition {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.RightCondition) > 0 {
		for _, e := range m.RightCondition {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.OtherCondition) > 0 {
		for _, e := range m.OtherCondition {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *Join) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeftCondition", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LeftCondition = append(m.LeftCondition, &Expr{})
			if err := m.LeftCondition[len(m.LeftCondition)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RightCondition", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RightCondition = append(m.RightCondition, &Expr{})
			if err := m.RightCondition[len(m.RightCondition)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OtherCondition", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OtherCondition = append(m.OtherCondition, &Expr{})
			if err := m.OtherCondition[len(m.OtherCondition)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
