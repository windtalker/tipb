...
type Join struct {
	JoinType         *JoinType     `protobuf:"varint,1,req,name=join_type,json=joinType,enum=tipb.JoinType" json:"join_type,omitempty"`
	JoinExecType     *JoinExecType `protobuf:"varint,2,req,name=join_exec_type,json=joinExecType,enum=tipb.JoinExecType" json:"join_exec_type,omitempty"`
	Children         []*Executor   `protobuf:"bytes,3,rep,name=children" json:"children,omitempty"`
	InnerIdx         *int64        `protobuf:"varint,4,req,name=inner_idx,json=innerIdx" json:"inner_idx,omitempty"`
	LeftJoinKeys     *Expr         `protobuf:"bytes,5,req,name=LeftJoinKeys" json:"LeftJoinKeys,omitempty"`
	RightJoinKeys    *Expr         `protobuf:"bytes,6,req,name=RightJoinKeys" json:"RightJoinKeys,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}
...
func (m *Join) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LeftJoinKeys == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.LeftJoinKeys.Size()))
		n9, err := m.LeftJoinKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	}
	if m.RightJoinKeys == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x32
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.RightJoinKeys.Size()))
		n10, err := m.RightJoinKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *Join) Size() (n int) {
	...
	if m.LeftJoinKeys != nil {
		l = m.LeftJoinKeys.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
	if m.RightJoinKeys != nil {
		l = m.RightJoinKeys.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *Join) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.LeftJoinKeys.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		...
		case 6:
			...
			if m.RightJoinKeys == nil {
				m.RightJoinKeys = &Expr{}
			}
			if err := m.RightJoinKeys.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorExecutor = []byte{
	...
	,
}
